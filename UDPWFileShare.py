...
host_name = Label(frame, text="HOST NAME: " + gethostname(), font=("Arial", 13, "bold"), bg="lightblue",
                  fg="darkblue")
host_name.pack(ipadx=80, fill=BOTH)

# Displaying Ip Address
ip_name = Label(frame, text="IP ADDRESS: " + gethostbyname(gethostname()), font=("Arial", 13, "bold"),
